...
void NhapThongTin(CustomerAccounts &a)
{
	size++;
	cin.ignore();
	cout << "Nhap ten: " ; getline(cin,a.ten); v.push_back(a.ten);
...
int main()
{
	...
	while(1)
	{
		system("cls");
		Menu();
		int nhap; cout << "Lua chon[1-5]: "; cin >> nhap;
		if(nhap >= 1 && nhap <= 4)
		{
			if(nhap == 1)
			{
			...
			else if(nhap == 4)
			{
				...
				if(kt)
				{
					cout << "Khong ton tai khach hang nay!" << endl;
					system("pause");
				}
