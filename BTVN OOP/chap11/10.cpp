...
void Nhap(Bureau &a)
{
	...
	cout << "Nhap Chu de: " ; cin >> a.chuDe; v.push_back(a.chuDe);
...
int main()
{
	...
	while(1)
	{
		...
		{
			string s;cout << "Nhap chu de can tim kiem: ";
			cin >> s;
			bool kt = true;
			...
			if(kt)
			{
				cout << "Khong ton tai chu de nao\n";
			}
			system("pause");
		}
		
		
		else if(nhap == 5) exit(0);
